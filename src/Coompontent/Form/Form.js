                    ...
                    <div className="chat-box-header p-15 d-flex justify-content-between align-items-center">
                        <div className="btn-group">
                            ...
                            <div className="dropdown-menu min-w-200">
                                <Link className="dropdown-item fs-16" to="#">
                                    <span className="icon-Color me-15"></span>
                                    New Group</Link>
                                <Link className="dropdown-item fs-16" to="#">
                                    <span className="icon-Clipboard me-15"><span className="path1"></span><span
                                ...
                                <Link className="dropdown-item fs-16" to="#">
                                    ...
                                    Groups</Link>
                                <Link className="dropdown-item fs-16" to="#">
                                    <span className="icon-Active-call me-15"><span className="path1"></span><span
                                        className="path2"></span></span>
                                    Calls</Link>
                                <Link className="dropdown-item fs-16" to="#">
                                    <span className="icon-Settings1 me-15"><span className="path1"></span><span
                                        className="path2"></span></span>
                                    Settings</Link>
                                <div className="dropdown-divider"></div>
                                <Link className="dropdown-item fs-16" to="#">
                                    <span className="icon-Question-circle me-15"><span className="path1"></span><span
                                        className="path2"></span></span>
                                    Help</Link>
                                <Link className="dropdown-item fs-16" to="#">
                                    <span className="icon-Notifications me-15"><span className="path1"></span><span
                                        className="path2"></span></span>
                                    Privacy</Link>
                            </div>
                        </div>
                        ...
                        <div className="chat-logs">
                            <div className="chat-msg user">
                                <div className="d-flex align-items-center">
                                    <span className="msg-avatar">
                                        <img src="images/2.jpg" className="avatar avatar-lg" alt=""/>
                                    </span>
                                    <div className="mx-10">
                                        <Link to="#" className="text-dark hover-primary fw-bold">Mayra Sibley</Link>
                            ...
                            <div className="chat-msg self">
                                <div className="d-flex align-items-center justify-content-end">
                                    <div className="mx-10">
                                        <Link to="#" className="text-dark hover-primary fw-bold">You</Link>
                                        <p className="text-muted fs-12 mb-0">3 minutes</p>
                                    </div>
                                    <span className="msg-avatar">
                                        <img src="images/3.jpg" className="avatar avatar-lg" alt=""/>
                                    </span>
                                </div>
                                <div className="cm-msg-text">
